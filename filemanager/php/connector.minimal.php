...
$opts = array(
	...
	'roots' => array(
		array(
			...
			'path'          => '../../pt/slides/src/slides/',                 // path to files (REQUIRED)
//			'path'          => '../files/',                 // path to files (REQUIRED)
//			'URL'           => 'http://' . $_SERVER['SERVER_ADDR'] . '/../pt/slides/src/slides/', // URL to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../../pt/slides/src/slides/', // URL to files (REQUIRED)

			'uploadDeny'    => array('all'),                // All Mimetypes not allowed to upload
			'uploadAllow'   => array('image/jpeg','image/png','image/gif','video/mp4','video/mkv'),// Mimetype `image` and `video` allowed to upload
			'uploadOrder'   => array('deny', 'allow'),      // allowed Mimetype `image` and `text/plain` only
	'disabled' => array('mkdir','mkfile','info','edit','extract','archive','help','open'),
