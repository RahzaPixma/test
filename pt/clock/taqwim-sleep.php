...
$gbl_secs_startdate_current = 0;
$gbl_secs_enddate_current = 0;

$gbl_ulang = 0;
$gbl_secs_todayenddate_current = 0;

while( $row = mysqli_fetch_array($result,MYSQLI_ASSOC) ) {
	$secs_startdate = strtotime($row["startdate"]);
	$secs_enddate = strtotime($row["enddate"]);
	$gbl_ulang = $row["ulang"];

	$masa_tamatsleep = substr($row["enddate"],11,8);
	$gbl_secs_todayenddate_current = strtotime( date('Y-m-d') . ' ' . $masa_tamatsleep );
...
//Trigger dlm range
	if( $gbl_ulang == 0 ) {
		if( $current_time_to_compare >= $secs_startdate  && $current_time_to_compare <= $secs_enddate) {
			$gbl_secs_startdate_current = $secs_startdate;
			$gbl_secs_enddate_current = $secs_enddate;
		}
	}
}
...
<script type="text/javascript">
			...
			var gblFlagIqo = 0;
			var gbl_secs_enddate_current = <?php echo $gbl_secs_enddate_current; ?>;
			var gbl_ulang = <?php echo $gbl_ulang; ?>;
			var gbl_secs_todayenddate_current = <?php echo $gbl_secs_todayenddate_current; ?>;
			...
			//ASAL B4 V5 setTimeout('move()',taqwimduration*1000);
			   //chk enddate is over
			   var chkIntervalId4 = setInterval ( "chkEnddateOver()", 2000 );
		    ...
		    //chk if enddate is over
			function chkEnddateOver()
			{
//alert('chk enddate over');
				var date_now = new Date();  
				var secs = (date_now.getTime())/1000;
//				console.log(secs);

				if( gbl_ulang == 1 ) {
					if ( secs > gbl_secs_todayenddate_current && gbl_secs_todayenddate_current != 0) {
	//alert('pergi ke slide=' + gbl_secs_enddate_current);				   
					   window.location = "/pt/slides/src/slide.php";  //pergi ke selingan slide
					   }					
				}
				else {
					if ( secs > gbl_secs_enddate_current && gbl_secs_enddate_current != 0) {
	//alert('pergi ke slide=' + gbl_secs_enddate_current);				   
					   window.location = "/pt/slides/src/slide.php";  //pergi ke selingan slide
					   }
				}
...
<div class="background" style="position: absolute; top: 0; left: 0; width: 1280px; height: 720px; background-image:url('../bg/bg-taqwim-sleep.jpg');
...
if($wnow == 2) {	
?>
   <div id="imsak" style="position: absolute; top: 490px; left: 1080px; width: 80px; height: 125px; font-size: 55px; font-family: Verdana Bold; font-weight: bold; color: green;">
 <?php 
}
else {
?>
   <div id="imsak" style="position: absolute; top: 490px; left: 1080px; width: 80px; height: 125px; font-size: 55px; font-family: Verdana Bold; font-weight: bold; color: black;">
<?php
}
?>
...
if($wnow == 3) {	
?>
   <div  id="subuh" style="position: absolute; top: 490px; left: 910px; width: 100px; height: 125px;  font-size: 55px; font-family: Verdana Bold; font-weight: bold; color: green;">
 <?php 
}
else {
?>
   <div  id="subuh" style="position: absolute; top: 490px; left: 910px; width: 100px; height: 125px;  font-size: 55px; font-family: Verdana Bold; font-weight: bold; color: black;">
<?php
}
?>
 ...
 ?>
   ...
   <div  id="syuruk" style="position: absolute; top: 490px; left: 740px; width: 100px; height: 125px;  font-size: 55px; font-family: Verdana Bold; font-weight: bold; color: black;">
  <?php 
 ...
 ?>
  ...
  <?php 
   ...
   //new sabah
  if($xzohor == 11) {
      echo "<div id=\"zohor\" style=\"position: absolute; top: 490px; left: 546px; width: 100px; height: 125px;  font-size: 55px; font-family: Verdana Bold;  font-weight: bold; color: $color_wzohor; text-align:right\">"; 
   }
   
   if($xzohor == 12) {
      echo "<div id=\"zohor\" style=\"position: absolute; top: 490px; left: 550px; width: 100px; height: 125px;  font-size: 55px; font-family: Verdana Bold;  font-weight: bold; color: $color_wzohor; text-align:right\">"; 
   }

  if($xzohor < 11) {
       echo "<div id=\"zohor\" style=\"position: absolute; top: 490px; left: 570px; width: 100px; height: 125px;  font-size: 55px; font-family: Verdana Bold;  font-weight: bold; color: $color_wzohor; text-align:right\">"; 
   }
...
if($wnow == 6) {	
?>
   <div  id="asar" style="position: absolute; top: 490px; left: 390px; width: 100px; height: 125px; font-size: 55px; font-family: Verdana Bold;  font-weight: bold; color: green;">
 <?php 
}
else {
?>
   <div  id="asar" style="position: absolute; top: 490px; left: 390px; width: 100px; height: 125px; font-size: 55px; font-family: Verdana Bold;  font-weight: bold; color: black;">
<?php
}
?>
...
if($wnow == 7) {	
?>
<div  id="maghrib" style="position: absolute; top: 490px; left: 220px; width: 100px; height: 125px;  font-size: 55px; font-family: Verdana Bold;  font-weight: bold; color: green;">
 <?php 
}
else {
?>
	<div  id="maghrib" style="position: absolute; top: 490px; left: 220px; width: 100px; height: 125px;  font-size: 55px; font-family: Verdana Bold;  font-weight: bold; color: black;">
<?php
}
?>
...
?>
       <div  id="isyak" style="position: absolute; top: 490px; left: 60px; width: 100px; height: 125px;  font-size: 55px; font-family: Verdana Bold;  font-weight: bold; color: green;">
<?php 
}
else {
?>
    <div  id="isyak" style="position: absolute; top: 490px; left: 60px; width: 100px; height: 125px;  font-size: 55px; font-family: Verdana Bold;  font-weight: bold; color: black;">
<?php
}
?>
