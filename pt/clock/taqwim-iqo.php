...
// 2/8/2020
			if( (mSec2 > 0) && (mSec2 < ((dIqomah*60*1000) + 2000) ) && nextday == 0 ) {  //version 5.4.2 (+2000 elak hang)
				...
				if (nextday == 0  && wnow != 1) {
					if( mSec <= 0 )
					  ...
					  window.location = "../solat.php?wnow=<?php echo $wnow; ?>";
						...
						if( gblFlagIqo == 0 ) {
							document.getElementById("iqomahtext").innerHTML = "IQOMAH";
							document.getElementById("countdowniqomah").innerHTML = "<span style='font-size: 83px; color:black; position: absolute; top: 250px; left: 850px; z-index: 23;' class='counter counter-analog3' data-direction='down' data-format='59: 59' data-stop='00:00' data-interval='1000'>" + dSolatMin + ":" + secs + "</span>";
							$('.counter').counter({});
							gblFlagIqo = 1;
						}
					} //else
			...
			function move() {
			// if (namaSolat == "syuruk") window.location = "../digit/worldclock3.php";
			//window.location = "jam.php";
...
<body onload="chkWaktuHandler()" class="fullheight">
       ...
       <script type="text/javascript" src="lib/jquery.jdigiclock.js"></script>
	      ...
	      <span id="countdowniqomah" style="font-size: 153px; color:black; position: absolute; top: 150px; left: 630px; z-index: 23;" class="counter counter-analog3" data-direction="down" data-format="59: 59" data-stop="00:00" data-interval="1000"></span>	
	  <div id="iqomahtext" style="z-index: 22; position: absolute; top: 40px; left: 770px; width: 100px; height: 125px;  font-size: 90px; font-family:  Verdana Bold;  color: white;">
	  </div>

	  <div id="based-iqomah" style="z-index: 19; position: absolute; top: 50px; left: 730px; width:500px; height:95px;">
	    <img src= '../bg/based-iqomah.jpg'></img>
	  </div>	  
