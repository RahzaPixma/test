...
<div style="font-size: 80px; font-family: Verdana Bold;  font-weight: bold; color: white">
<?php 
...
<td rowspan="2"  width="530" style="border: 0px solid black; font-size: 85px; font-family: Verdana Bold;  font-weight: bold; color: white"><?php echo $kuliah_header; ?></td>
</tr>
