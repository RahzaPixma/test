...
function FlightBoard() {
	this._defaults = {
		//lettersImage: 'flightBoardLarge2.png', // Amalgamated image for letters background
//		lettersImage: '37charswhite.png', // Amalgamated image for letters background
		lettersSize: [50, 68], // Width and height of individual letters
...
/**PC		flips: [3, 8], // Number of flips before new value,
...
//RASPI
		flips: [2, 3], // Number of flips before new value,
			// may be an array with minimum and maximum flips
		sequential: false, // True to step through all letters, false for random ones
		speed: 2500, // Time taken (milliseconds) for a single transition
		repeat: false, // True to automatically trigger a new transition after a pause
		pause: 1500, // Time (milliseconds) between transitions
//END
