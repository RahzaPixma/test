...
(function(a) {
    ...
    c.defaultOptions = {
        ...
        templates: {
            ...
            search: '<input type="search" class="iconpicker-search" placeholder="Type to filter" />',
