...
if( strlen($file_slide) < 2 )
  $sql = "update template_kuliah_tetap set header='$header',tajuk='$tajuk',hari='$hari',waktu='$waktu',penceramah='$penceramah',tempat='$tempat',catatan='$catatan',susunan=$susunan,status=$status,filetemplate='$filetemplate',show_slide='$show_slide', batal=$batal where id=$id";
else 
  $sql = "update template_kuliah_tetap set header='$header',tajuk='$tajuk',hari='$hari',waktu='$waktu',penceramah='$penceramah',tempat='$tempat',catatan='$catatan',susunan=$susunan,status=$status,filetemplate='$filetemplate',show_slide='$show_slide',file_slide='$file_slide', batal=$batal where id=$id";
