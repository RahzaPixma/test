...
$sql = "insert into template_kuliah_tetap(header,tajuk,hari,waktu,penceramah,tempat,catatan,susunan,status,filetemplate,show_slide,file_slide,batal) values('$header','$tajuk','$hari','$waktu','$penceramah','$tempat','$catatan',$susunan,$status,'$filetemplate','$show_slide','$file_slide',$batal)";
