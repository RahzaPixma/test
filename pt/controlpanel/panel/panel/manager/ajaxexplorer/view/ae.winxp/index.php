	...
	<body id="aeBody">
		...
		<div id="aeHeader">
			<div id="aeMainMenu" class="border">
				...
				<img id="icon31" alt="" src="<?php echo $this->strHrefTemplate; ?>/css/images/icon/home.png" class="icon" title="Home" /> 
				...
				<img id="icon23" alt="" src="<?php echo $this->strHrefTemplate; ?>/css/images/layout/divider.gif" class="icon" title="" /> 
...
<!--				<div class="menu"><span id="syst11" onclick="userSystemTab(this, 0)">Detail</span><span onclick="userSystemTab(this, 1)">Profile</span><span onclick="userSystemTab(this, 2)">Manage Users</span></div> -->
				<div class="menu"><span id="syst11" onclick="userSystemTab(this, 1)">Profile</span></div>  
				<div class="area">
