...
<div  align="center" style="position: absolute; width: 420px; left:840px; top: 90px; font-size: 55px; font-family: Verdana Bold;  font-weight: bold; color: maroon;">
<?php
echo $kuliah_hari; 
 ?>
</div>
...
<div  align="center" style="position: absolute; width: 420px; left:840px; top: 380px; font-size: 45px; font-family: Verdana Bold; color:black;">
MASA :
</div>

<div  align="center" style="position: absolute; width: 200px; left:940px; top: 440px; font-size: 40px; font-family: Verdana Bold;  font-weight: bold; color: white;">
<?php
//$kuliah_waktu = "Isyak";
echo $kuliah_waktu; 
 ?>
...
?>
<div  style="position: absolute; width: 800px; left:90px; top: 230px; font-size: 55px; font-family: Verdana Bold;  font-weight: bold; color: black">
<?php
} else {
?>
<div  style="position: absolute; width: 800px; left:90px; top: 180px; font-size: 55px; font-family: Verdana Bold;  font-weight: bold; color: black">
<?php
}
...
<div  style="position: absolute; width: 800px; left:90px; top: 360px; font-size: 55px; font-family: Verdana Bold;  font-weight: bold; color: blue">
<u>Penceramah</u> :
</div>

<div  style="position: absolute; width: 800px; left:90px; top: 420px; font-size: 55px; font-family: Verdana Bold;  font-weight: bold; color: blue">
<?php 
